...
module moore ( clk, n_rst, i, o );
  ...
  OAI21X1 U26 ( .A(n21), .B(n22), .C(n23), .Y(nxt_state[2]) );
  OAI21X1 U27 ( .A(state[0]), .B(state[1]), .C(state[2]), .Y(n23) );
  NAND2X1 U28 ( .A(state[0]), .B(i), .Y(n22) );
  OAI21X1 U29 ( .A(state[0]), .B(n21), .C(n24), .Y(nxt_state[1]) );
  ...
  MUX2X1 U36 ( .B(n29), .A(n20), .S(state[2]), .Y(nxt_state[0]) );
