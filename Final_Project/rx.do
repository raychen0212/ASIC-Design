...
add wave -noupdate -color Gold /tb_rx_full_design/DUT/timer_rx/shift_enable
add wave -noupdate -color Gold /tb_rx_full_design/DUT/controller/byte_detect
add wave -noupdate /tb_rx_full_design/DUT/edging/edge_detect
add wave -noupdate /tb_rx_full_design/DUT/rx_transfer_active
add wave -noupdate /tb_rx_full_design/DUT/s_val
...
add wave -noupdate -expand -group Signal /tb_rx_full_design/DUT/d_orig
add wave -noupdate -color Blue /tb_rx_full_design/tb_input_byte
add wave -noupdate -color Blue /tb_rx_full_design/tb_e_input_byte
add wave -noupdate -expand -group rx_data_ready /tb_rx_full_design/tb_rx_data_ready
add wave -noupdate -expand -group rx_data_ready /tb_rx_full_design/check_output/expected_rx_data_ready
...
WaveRestoreCursors {{Cursor 1} {1043325 ps} 0}
...
update
WaveRestoreZoom {0 ps} {1199628 ps}
